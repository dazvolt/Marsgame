	...
	ru : {
		...
		buildings : {
			...
			uranium_plant : {
				...
				desc : 'Завод по выработке урана позволяет добывать ресурс уран. Каждое здание повышает выработку на: +',
			},
			helium_plant : {
				name : 'Завод по выработке гелия-3 [ВГ]',
				desc : 'Завод по выработке гелия-3 позволяет добывать ресурс гелий-3. Каждое здание повышает выработку на: +',
			},
			housing_plant : {
